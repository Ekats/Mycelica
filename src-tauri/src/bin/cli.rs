...
/// Thin wrapper around `mycelica_lib::rebuild::rebuild_adaptive`.
async fn rebuild_hierarchy_adaptive(
    ...
    use mycelica_lib::rebuild::{RebuildConfig, rebuild_adaptive};
    ...
    let result = rebuild_adaptive(db, config, &|msg| {
